...
public class Meal extends AbstractBaseEntity {
    ...
    @NotNull(groups = {SpringMvcValidation.class, Default.class})
    private LocalDateTime dateTime;

    @Column(name = "description", nullable = false)
    @NotBlank
    @Size(min = 2, max = 120, groups = {SpringMvcValidation.class, Default.class})
    private String description;

    @Column(name = "calories", nullable = false)
    @Range(min = 10, max = 5000, groups = {SpringMvcValidation.class, Default.class})
    @NotNull(groups = SpringMvcValidation.class)
