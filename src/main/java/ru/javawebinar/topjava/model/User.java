...
@Entity
@Table(name = "users", uniqueConstraints = {@UniqueConstraint(columnNames = "email", name = User.EMAIL_INDEX)})
public class User extends AbstractNamedEntity {

    public static final String EMAIL_INDEX = "users_unique_email_idx";
